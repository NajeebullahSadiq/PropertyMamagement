...
} from 'src/app/shared/vehicle-report.service';
...
export class VehicleReportComponent extends BaseComponent implements OnInit {
    isLoading = false;
    activeTab = 'summary';
    ...
    // Report data
    summary: VehicleReportSummary | null = null;
