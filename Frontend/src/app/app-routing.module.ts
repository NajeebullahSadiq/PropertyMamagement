...
const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'estate-report', loadChildren: () => import('./estate-report/estate-report.module').then(m => m.EstateReportModule), canActivate: [PropertyModuleGuard] },
      ...
      { path: 'vehicle-report', loadChildren: () => import('./vehicle-report/vehicle-report.module').then(m => m.VehicleReportModule), canActivate: [VehicleModuleGuard] },
      { path: 'users', loadChildren: () => import('./users/users.module').then(m => m.UsersModule), canActivate: [AdminGuard] },
      { path: 'user-report', loadChildren: () => import('./user-report/user-report.module').then(m => m.UserReportModule), canActivate: [AdminGuard] },
